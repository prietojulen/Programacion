...
public class Persona {
    ...
    public Persona(String dni, String nss, String nombreApellido, String direccion, String telefono, String sexo, String estadoCivil, Date fechaAlta, int numeroEmpleado, Contrato C, Departamento D, Usuario U) {
        this.dni = dni;
        this.nss = nss;
        this.nombreApellido = nombreApellido;
        this.direccion = direccion;
