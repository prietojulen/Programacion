...
// https://jar-download.com/artifacts/com.github.lgooddatepicker
// http://plugins.netbeans.org/plugin/63040/lgooddatepicker
...
private void bAñadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAñadirActionPerformed
   try{
         if (tfNombreHijo.getText().isEmpty() || dpFechaNac.getDate() == null)
                    throw new CampoObligatorio();
          // que no sea superior a la actual
         if (dpFechaNac.getDate().isAfter(LocalDate.now())) 
               throw new FechaNoValida();
         Main.añadirHijo(tfNombreHijo.getText(),dpFechaNac.getDate());
         limpiar();
   }
   catch(CampoObligatorio e){
        javax.swing.JOptionPane.showMessageDialog(this,"En este formulario hay datos obligatorios");
